...
head_test = [0, 3, 6, 9, 12, 15, 18, 21, 24, 27] 
print (head(head_test))
...
def inner_four_end(input_list):
    ...
    return input_list[-4:2:-1]
print (inner_four_end(head_test))
...
def replace_third_and_last(input_list):
    ...
    return input_list
print (replace_third_and_last(head_test))
